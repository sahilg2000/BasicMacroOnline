...
db.once("open", () => {
    console.log("Successfully connected to MongoDB Macros Data using Mongoose!");
});
...
const createMacro = async (name, weight, carbs, fats, proteins) => {
    const macro = new Macro({name: name, weight: weight, carbs: carbs, fats :fats, proteins: proteins});
    return macro.save();
}
